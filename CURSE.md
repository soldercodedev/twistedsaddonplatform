...
recap** — printed to *your* chat only — when you regroup with someone. Everything stays **local and
private**: no data is uploaded, and there are no ratings, blacklists, or judgements of other players.

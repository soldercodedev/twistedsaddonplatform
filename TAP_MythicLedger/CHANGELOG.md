...
**Missed Kick** deaths and a new on-screen **death report**, building on beta.7's attribution. The scoring change below **re-scores your existing runs automatically** on login.
